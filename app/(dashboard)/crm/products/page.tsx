...
export default function ProductsPage() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-charcoal">Products & Services</h1>
        <p className="text-sm text-stone mt-1">Manage your product catalog and service offerings</p>
      </div>

      <ProductList organizationId={organizationId} />
    </div>
  );
}
