    ...
    <>
      ...
      <section className="bg-cream py-16 px-6">
        <div className="max-w-[780px] mx-auto prose prose-charcoal">
          ...
          <p className="text-[17px] leading-[1.9] text-[#555]">We collect the following types of information:</p>
          ...
          <p className="text-[17px] leading-[1.9] text-[#555]">Under POPIA and applicable laws, you have the right to:</p>
          <ul className="text-[17px] leading-[1.9] text-[#555] space-y-2">
