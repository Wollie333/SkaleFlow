...
-- Allows creating reusable role templates like
-- "Social Media Manager", "Content Creator", etc.
-- =====================================================
...
CREATE TABLE permission_templates (
  ...
  -- System templates are predefined (e.g., "Social Media Manager")
  -- Custom templates are created by org admins
  ...
  -- Ensure unique names per organization (or system-wide for system templates)
...
-- Users can view system templates and their org's templates
...
-- Only org admins can manage custom templates
...
-- Predefined role templates for common team positions
-- =====================================================
...
-- Track which templates were applied to users
-- =====================================================
...
CREATE TABLE permission_template_assignments (
  ...
  -- Store snapshot of permissions at time of application
