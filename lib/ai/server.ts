/**
 * Server-only AI utilities.
 * This file contains functions that use server-side Supabase client.
 * DO NOT import this file in client components.
 */

import { createServiceClient } from '@/lib/supabase/server';
import { getModelConfig, getDefaultModelForFeature } from './providers/registry';
...
export async function getAvailableModels(
  ...
  const { MODEL_CATALOG } = await import('./providers/registry');
...
// Re-export all server-side credit functions
export {
  calculateCreditCost,
  checkCredits,
  deductCredits,
