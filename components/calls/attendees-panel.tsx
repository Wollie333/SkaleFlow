  ...
  return (
    <div className="flex flex-col h-full">
          ...
          <div>
            ...
            <div className="space-y-1">
              {inCall.map(p => {
                ...
                return (
                  <div key={p.id} className="flex items-center gap-2 p-2 rounded-lg hover:bg-cream/5 group">
      ...
      <div className="p-3 border-t border-white/10">
        <button
          onClick={copyLink}
          className="w-full py-2 rounded-lg bg-cream-warm/10 text-white text-sm hover:bg-cream/15 transition-colors"
        >
